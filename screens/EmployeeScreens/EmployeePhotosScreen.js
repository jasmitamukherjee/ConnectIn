    ...
    <SafeAreaView>
      <View style={{marginTop: 90, marginHorizontal: 20}}>
        ...
        <Text
          ...
          Pick the best professional photos to make your profile more attractive.
        </Text>
        ...
        <View style={{marginTop: 25}}>
          <Text style={{fontFamily:"monospace",}}>Add a picture of yourself.</Text>
          <View
            style={{
              flexDirection: 'row',
              alignItems: 'center',
            ...
            <TextInput
              ...
              style={{color: 'gray', marginVertical: 10, width: 300,fontFamily:"monospace",}}
              placeholder="Please enter your image url."
            />
          </View>
          <Button
            onPress={handleAddImage}
            style={{marginTop: 5,fontFamily:"monospace",}}
            title="Add Image"
            color="#502b63"
