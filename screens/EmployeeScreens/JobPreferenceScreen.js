...
const JobPreferenceScreen = () => {
 ...
 name="magnify-scan" size={26} color="black" />
          ...
          <Text style={{ fontFamily:"monospace",fontSize: 25, fontWeight: 'bold', color: 'black', marginTop: 15 }}>Enter your job preferences.</Text>
          <Text style={{fontFamily:"monospace", marginTop: 30, fontSize: 15, color: 'gray' }}>Select all that you're looking for in your dream company.</Text>
